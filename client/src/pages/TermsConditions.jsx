  ...
  const fetchPolicy = async () => {
    try {
      ...
      setPolicy({
        ...
        sections: [
          { heading: '1. Acceptance of Terms', content: 'By accessing and using KheloLudo, you accept and agree to be bound by the terms and provision of this agreement.' },
          { heading: '2. Eligibility', content: 'You must be at least 18 years old to use this service. By using KheloLudo, you represent that you meet this age requirement.' },
